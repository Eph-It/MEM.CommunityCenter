...
namespace CommunityCenter.UI
{
    public class Startup
    {
        ...
        {
            var ccDev = Environment.GetEnvironmentVariable("CommunityCenterDevelopmentTestUser");
            if(ccDev == "true")
            {
            ...
            services.AddSingleton<CMClient>();
        }
